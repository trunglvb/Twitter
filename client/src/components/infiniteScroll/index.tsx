...
interface InfiniteScrollProps {
	...
	rootMargin?: string;
	reverse?: boolean;
	direction?: "top" | "bottom"; // New prop to explicitly control scroll direction
...
export default function InfiniteScroll({
	...
	rootMargin = "0px",
	reverse,
	direction = "bottom", // Default to bottom scrolling
	children,
}: InfiniteScrollProps) {
	...
	return (
		<>
			{flattenChildren.map((child, index) => {
				...
				// Determine which element to observe based on direction or reverse prop
				// If direction is specified, it takes precedence over the reverse prop
				const isObserveTarget =
					direction === "top"
						? index === 0
